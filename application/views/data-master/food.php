        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <?= form_error('food', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="badge bg-success updateBenua" data-bs-toggle="modal"
                                            data-bs-target="#editCont" data-id="<?= $ct['id'] ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="setRoleModalLabel">Tambah Data Makanan</h1>
