                                ...
                                <?php foreach ($fish_type as $ct) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="badge bg-success updateBenua" data-bs-toggle="modal" data-bs-target="#editCont" data-id="<?= $ct['id'] ?>" data-type="<?= $ct['type'] ?>" data-description="<?= $ct['description'] ?>">Ubah</a>
