            ...
            <form action="<?= base_url('Laundry/kurir') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= (form_error('no_ktp')) ? 'is-invalid' : '' ?>" id="no_ktp" name="no_ktp" placeholder="Nama Lengkap" value="<?= set_value('no_ktp') ?>">
                        <div class="form-control-icon">
                            <i class="bi bi-shield-lock"></i>
                        </div>
