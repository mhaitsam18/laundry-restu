<div class="page-content">
    ...
    <div class="row">
        <div class="col-4 col-xl-4 stretch-card">
            <div class="card">
                <div class="card-body p-5">
                    ...
                    <h4 class=" mb-3">Pilih Tahun dan Bulan</h4>
                    <div class="row">
                        <div class="col-lg-10">
        ...
        <div class="col-4 col-xl-4 stretch-card">
            <div class="card">
                <div class="card-body p-5">
                    <h3 class=" mb-3">Laporan Pemasukan</h3>
                    <h4 class=" mb-3">Pilih Tahun dan Bulan</h4>
                    <div class="row">
                        <div class="col-lg-10">
                            <form action="<?= base_url('Laundry/Laporan/print') ?>" method="post" target="_blank ">
                                <input type="hidden" name="aksi" value="pemasukan">
                                <div class="mb-3">
                                    <label for="tahun" class="form-label">Tahun</label>
                                    <input type="number" class="form-control" name="tahun" id="tahun" required value="<?= date('Y') ?>">
                                </div>
        ...
        <div class="col-4 col-xl-4 stretch-card">
            <div class="card">
                <div class="card-body p-5">
                    <h3 class=" mb-3">Laporan Pengeluaran</h3>
                    <h4 class=" mb-3">Pilih Tahun dan Bulan</h4>
                    <div class="row">
                        <div class="col-lg-10">
                            <form action="<?= base_url('Laundry/Laporan/print') ?>" method="post" target="_blank ">
                                <input type="hidden" name="aksi" value="pengeluaran">
                                <div class="mb-3">
                                    <label for="tahun" class="form-label">Tahun</label>
                                    <input type="number" class="form-control" name="tahun" id="tahun" required value="<?= date('Y') ?>">
                                </div>
